...
import { CYAN, NAVY, BLUE, MUTED, monoFont, sansFont } from '../theme'
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '12px 28px',
              background: isHovered ? CYAN : 'rgba(62,196,192,0.15)',
              border: '1px solid rgba(62,196,192,0.4)',
              borderRadius: 8,
              fontFamily: monoFont,
              fontSize: 12,
              fontWeight: 700,
              color: isHovered ? NAVY : CYAN,
              cursor: 'pointer',
              letterSpacing: '0.08em',
            ...
            <div style={{ display: 'flex', gap: '16px' }}>
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 8px 24px rgba(62,196,192,0.3)'
                }}
                onMouseLeave={(e) => {
